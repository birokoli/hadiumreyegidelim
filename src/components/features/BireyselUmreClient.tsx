...
export default function BireyselUmreClient({ 
  ...
  // İlk yüklemede, eğer dışarıdan özel bir kalkış şehri (SEO üzerinden) verilmişse onu ayarla
  useEffect(() => {
    if (initialDepartureCity) {
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="bg-surface-container-lowest p-8 md:p-10 rounded-3xl border border-outline-variant/15 shadow-sm">
              ...
              <div className="space-y-6">
                 ...
                 <div className="bg-[#e0f5eb] border border-[#11A851]/30 p-4 rounded-xl flex items-start gap-3">
